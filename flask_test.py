...
class FlaskappTest(unittest.TestCase):
    ...
    def test_addusers_status_code(self):
        ...
        result = self.app.post('/api/v1/users', data='{"username":"test\
_usr", "email":"tusr@test.local", "password":"test543"}', content_type=\
'application/json')
        print (result)
        # assert the status code of the response
    ...
    def test_updusers_status_code(self):
        ...
        result = self.app.put('/api/v1/users/17', data='{"password":"te\
sting123"}', content_type='application/json')
        print (result)
        # assert the status code of the response
        self.assertEqual(result.status_code, 200)
    ...
    def test_addtweets_status_code(self):
        ...
        result = self.app.post('/api/v2/tweets', data='{"username":"tes\
t_usr","body":"Wow It works! #testing"}', content_type='application/json')
        # assert the status code of the response
        self.assertEqual(result.status_code, 200)
        # self.assertEqual(result.status_code, 201)
    ...
    def test_delusers_status_code(self):
        ...
        result = self.app.delete('/api/v1/users', data='{"username":"te\
st_usr"}', content_type='application/json')
        # assert the status code of the response
        self.assertEqual(result.status_code, 200)
